...
{
    [RoutePrefix("Account")]
    public class ExternalLoginAccountController : AccountController
    {
        //
        ...
        public ActionResult ExternalLogin(string provider, string returnUrl)
        {
            ...
            return new ChallengeResult(provider, Url.Action("ExternalLoginCallback", "ExternalLoginAccount", new { ReturnUrl = returnUrl }));
        }
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", "Account", new { ReturnUrl = returnUrl, RememberMe = false });
