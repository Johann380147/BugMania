...
namespace BugMania.Controllers
{
    public class TagController : Controller
    {
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            BugMania.Shapes.Tag tag = await db.Tags.FindAsync(id);
            if (tag == null)
            {
                return HttpNotFound();
            }
        ...
        {
            return PartialView("_CreateTagUI");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Description")] BugMania.Shapes.Tag tag)
        {
            if (ModelState.IsValid)
            {
